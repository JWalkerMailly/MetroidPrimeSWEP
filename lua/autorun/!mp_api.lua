...
CreateConVar("mp_cheats_suitvariant",  "Prime", { FCVAR_SERVER_CAN_EXECUTE, FCVAR_REPLICATED, FCVAR_ARCHIVE, FCVAR_CHEAT }, nil, 0, 1);
...
if (CLIENT) then
	...
	CreateClientConVar("mp_options_hudsway",         "1", true, false);
